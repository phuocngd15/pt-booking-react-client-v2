...
const CustomTable: React.FC<CustomTableProps> = ({ dataSource }) => {
  ...
  const columns: ColumnsType<DataType> = [
    {
      title: '#',
      render: (_text, _record, rowIndex) => rowIndex + 1,
    },
    {
      title: 'Start Time',
    ...
    { title: 'Create Date', dataIndex: 'create_time', key: 'create_time' },
    {
      title: 'Action',
      dataIndex: '',
      key: 'x',
  ...
  const expandColumns: ColumnsType<Trainer> = [
    {
      title: 'Class Name',
      dataIndex: 'name',
      key: 'name',
    ...
    { title: 'name', dataIndex: 'trainer', key: 'trainer' },
  ];
  ...
  return (
    <>
      <Table
        ...
        //    <Table columns={expandColumns} dataSource={record.classes}></Table>
        //   ), => nên dùng detail để quản lí
        //   rowExpandable: (record) => record.classes.length >0,
        // }}
