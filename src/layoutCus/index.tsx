...
const LayoutCus: React.FC = () => {
  const render = () => {
    return (
      ...
      <div>
        {/*<Menu*/}
        {/*  className="customMenu sticky top-0 z-40 w-full lg:z-50 lg:border-b lg:border-slate-900/10 bg-white supports-backdrop-blur:bg-white/95 "*/}
        {/*  mode="horizontal"*/}
      ...
      >
        {({ open }) => (
          <>
            ...
            <Disclosure.Panel className="sm:hidden" id="mobile-menu" aria-disabled={false}>
